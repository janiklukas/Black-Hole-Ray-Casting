...
The purpose of this project is to produce an image of a Schwarzschild black hole surrounded by a light-emitting accretion disc using ray casting: A set of light rays corresponding to pixels on an observer's screen is initialized and then evolved in time using the geodesic equation for lightlike particles.
